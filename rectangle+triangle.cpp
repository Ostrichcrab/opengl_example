...

{
	...
	glRectf(-0.3,-0.3,0.3,0.8);//开始画矩形
	glBegin(GL_TRIANGLES);
	glColor3f(1.0, 1.0, 1.0);

	glVertex2f(-0.30, 0);//设置第一个顶点的坐标

	glColor3f(1.0, 1.0, 1.0);

	glVertex2f(-0.60, -0.30);//设置第二个顶点的坐标

	glColor3f(1.0, 1.0, 1.0);

	glVertex2f(-0.3, -0.30);//设置第三个顶点的坐标
	...
	glVertex2f(0.30, -0.30);//设置第二个顶点的坐标

	glColor3f(1.0, 1.0, 1.0);

	glVertex2f(0.6, -0.30);//设置第三个顶点的坐标
